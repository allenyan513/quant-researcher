...
def _estimate_from_fmp(
    ...
    return {
        ...
        "revenue_avg": _as_float(row.get("revenueAvg")),
        "revenue_low": _as_float(row.get("revenueLow")),
        "revenue_high": _as_float(row.get("revenueHigh")),
        "eps_avg": _as_float(row.get("epsAvg")),
        "eps_low": _as_float(row.get("epsLow")),
        "eps_high": _as_float(row.get("epsHigh")),
        "ebitda_avg": _as_float(row.get("ebitdaAvg")),
        "net_income_avg": _as_float(row.get("netIncomeAvg")),
        "num_analysts_revenue": _as_int(row.get("numAnalystsRevenue")),
        "num_analysts_eps": _as_int(row.get("numAnalystsEps")),
        "raw": row,
        "known_at": datetime.now(UTC),
    }
